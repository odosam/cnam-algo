...
int main(){
    ...
    // -> faire une fonction normale mais sans return : passage des valeurs par des pointeurs. Valeurs qui seront récupérées
    //                                                  via le main grace à l'adresse. 
    float tabFloat[5];
